...
var frFR = {
  ...
  taskChooseOrganization: {
    ...
    alerts: {
      organizationAlreadyExists: "Une organisation existe d\xE9j\xE0 pour le nom d'entreprise d\xE9tect\xE9 ({{organizationName}}) et {{organizationDomain}}. Rejoignez par invitation."
    }
  },
  taskResetPassword: {
